 ...
 .pagination {
            ...
            <div>
                ...
                <ul class="responsive-table" id="empTable">
                    ...
                    <li class="table-row">
                        ...
                        <div class="col col-1">
                            <i class="fas fa-pencil-alt editIcon" data-toggle="modal" data-target="#viewFileModal" data-id="{{ $em->id }}"  data-name="{{  $em->name }}" data-mobile="{{ $em->mobile_no }}" data-email="{{  $em->email }}" data-position="{{ $em->position }}"></i>
                        </div>                        
                        <div class="col col-1">
                            <a href="#" onclick="confirmDelete('{{ route('delete_emp', ['id' => $em->id]) }}')">
    ...
    <div class="modal fade" id="viewFileModal" tabindex="-1" role="dialog" aria-labelledby="viewFileModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewFileModalLabel">Edit Employee</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="updateEmpBtn">Update Employee</button>
