...
<body>
    ...
    <div class="login-box">
        ...
        <form method="POST" action="{{ route('adminsignup') }}" id="signup-form">
            @csrf
            ...
            <div class="input-box">
                <label for="super-admin">Set as a Super Admin</label>
                <input type="checkbox" id="super-admin" name="super_admin" />
            </div>
            ...
            <div class="sign-up-link">
                Returning user? <a href="{{ route('admin_login') }}">Log in here</a>
            </div>
        </form>
    </div>
